...
export default function MembersOnlyBanner() {
  return (
    <div className="relative overflow-hidden rounded-xl" style={{ minHeight: '400px' }}>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 filter blur-[8px] opacity-60">
        {/* Fake job card 1 */}
        ...
        <div className="text-center">
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-block px-8 py-4 rounded-lg font-semibold text-white transition-all duration-200 hover:opacity-90 shadow-lg"
