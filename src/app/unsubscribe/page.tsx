    ...
    return (
      <div className="min-h-screen py-12">
        <div className="max-w-md mx-auto px-4">
          <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 text-center overflow-hidden">
            <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-red-100 mb-4">
              <svg className="h-8 w-8 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
              </svg>
            </div>
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 break-words">Invalid Link</h1>
      ...
      <div className="min-h-screen py-12">
        <div className="max-w-md mx-auto px-4">
          <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 text-center overflow-hidden">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 break-words">Unsubscribed!</h1>
            <p className="text-gray-600 mb-6">
    ...
    <div className="min-h-screen py-12">
      <div className="max-w-md mx-auto px-4">
        <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 text-center overflow-hidden">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 break-words">Something Went Wrong</h1>
          <p className="text-gray-600 mb-6">
